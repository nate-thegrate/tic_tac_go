...
void main() {
  test('brutal blocks dual open-three fork (loss 1)', () async {
    ...
    expect(await aiMove(.brutal, Ruleset.gomoku, BoardData(board)), (7, 6));
  });
  ...
  test('brutal occupies tempo-fork square (loss 2)', () async {
    ...
    expect(await aiMove(.brutal, Ruleset.gomoku, BoardData(board)), (11, 6));
  });
  ...
  test('brutal blocks open three before own attack (loss 3)', () async {
    ...
    final move = await aiMove(.brutal, Ruleset.gomoku, BoardData(board));
